...
extern const std::string
                         STATUS_CODE_HTTP_431_REQUEST_HEADER_FIELDS_TOO_LARGE; // = "431 Request Header Fields Too Large"s;
...
extern const std::string
    STATUS_CODE_HTTP_511_NETWORK_AUTHENTICATION_REQUIRED; // = "511 Network Authentication Required"s;
 ...
 * @return string
 */
auto to_string(StatusCode code) -> const std::string&;
...
auto to_string(ContentType content_type) -> const std::string&;
...
auto to_string(ConnectionType connection_type) -> const std::string&;
